...
// Fix for missing admin.addon.index route
Route::get('/admin/addon', function () {
    return redirect('/admin/payment/configuration/addon-payment-get');
})->name('admin.addon.index');
